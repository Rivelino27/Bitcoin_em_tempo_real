...
janela = Tk()
janela.title('Bitcoin em tempo real')
...
l_nome = Label(frame_principal, text="Bitcoin em tempo real", height=1, padx=0, relief="flat", anchor="w", font=('Arial 20 '), bg=co1, fg=co2)
